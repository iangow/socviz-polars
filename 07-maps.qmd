...
def build_counties(
    ...
    con.sql("""
        ...
        centroids AS (
            SELECT
                ST_X(ST_Centroid(ST_Union_Agg(geom_ak))) AS ak_x,
                ST_Y(ST_Centroid(ST_Union_Agg(geom_ak))) AS ak_y,
                ST_X(ST_Centroid(ST_Union_Agg(geom_hi))) AS hi_x,
                ST_Y(ST_Centroid(ST_Union_Agg(geom_hi))) AS hi_y
            FROM counties_raw
        )
        SELECT
